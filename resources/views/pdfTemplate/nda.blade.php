...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
  ...
  <!-- Bootstrap 3.3.7 -->
  <link rel="stylesheet" href="{{ public_path('assets/invoice_print/bootstrap.min.css') }}"  media="all" type="text/css">
  <link rel="stylesheet" href="{{ public_path('assets/invoice_print/AdminLTE.min.css') }}"  media="all"  type="text/css">
  <link rel="stylesheet" href="{{ public_path('assets/css/guest/nda_print.css') }}">
  <style>
      .invoice{
          margin:0 0;
      }
    ...
    <section class="invoice">
        <div class="row">
            <div class="col-md-12 banner">
                <table>
                    <tr class="logo-panel">
                        <td><img src="{{ public_path('assets/wbcolorlogo.jpg') }}" class='img-logo'></td>
                        <td class='logo-title'>Walnut LLC</td>
                    </tr>
                </table>
            </div>
            <div class="col-md-12">
        ...
        <div class="row form-panel">
            <table class='sign-table'>
                <tr>
                    <td style='width:50%'>
                        <h4>Walnut Distro</h4>
                        <img src="{{ public_path('sign.png') }}" class='walnut-sign' alt="">
                    ...
                    <td style='width:50%'>
                        ...
                        <img src="{{ public_path('storage/ndaSigns/'.$nda->signature_file) }}" class='walnut-sign' alt="">
                    </td>
                </tr>
            </table>
        </div>
