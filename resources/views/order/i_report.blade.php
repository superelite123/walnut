...
@section('title', 'WP Invoice Reports')
@section('css')
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <select class='form-control select2' id='l_type'>
                                @foreach ($lTypes as $lType)
                                    <option value="{{ $lType->type_id }}">{{ $lType->name }}</option>
                                @endforeach
                            </select>
                        </div>
                        <!-- /.input group -->
...
@section('js')
  ...
  <script type="text/javascript" src="{{ asset('assets/js/order/i_report.js') }}"></script>
@stop
